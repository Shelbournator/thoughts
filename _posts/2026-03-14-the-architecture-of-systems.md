...
graph TD
    subgraph "The Multi-Scale Architecture"
        ...
        L4["<b>Physical & Infrastructure Systems</b><br><i>Energy, Hardware, Geography</i>"]
    end

    L1 <==>|Top-Down Constraint / Bottom-Up Emergence| L2
    L2 <==>|Top-Down Constraint / Bottom-Up Emergence| L3
    L3 <==>|Top-Down Constraint / Bottom-Up Emergence| L4

    style L1 fill:#1a4d2e,stroke:#fff,color:#fff
    style L2 fill:#223c40,stroke:#fff,color:#fff
    style L3 fill:#3d3d3d,stroke:#fff,color:#fff
    style L4 fill:#555555,stroke:#fff,color:#fff
```
