...
math: false
mermaid: true
description: "Why I am applying systems thinking to bike maintenance. A case study in procurement, ROI, and the integration of abstract and concrete knowledge."
---
...
```mermaid
graph TD
    A[Sourcing Decision] --> B{Optimise for?}
    B -->|Tax Efficiency| C[Cycle to Work Scheme]
    B -->|Raw Value| D[Second-Hand Market]
    
    C --> E[New Bike - £1k+]
    D --> F[Used Bike - £350]
    
    style D fill:#1a4d2e,stroke:#fff,color:#fff
    style F fill:#1a4d2e,stroke:#fff,color:#fff
```
