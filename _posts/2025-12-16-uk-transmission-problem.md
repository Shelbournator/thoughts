---
title: "The UK's Transmission Problem: Why Productivity Doesn't Scale"
date: 2025-12-16 20:00:00 +0000
categories: [Systems, Economics]
tags: [uk-economy, scaling, infrastructure, strategy]
pin: false
math: false
mermaid: true
---
...
```mermaid
graph LR
    P[Productivity<br><i>Capability</i>] --> T{Transmission<br><i>Scaling & Allocation</i>}
    T -->|Success| O[Outputs<br><i>Growth & Wages</i>]
    T -.->|Failure| S[Stagnation]

    style P fill:#3d3d3d,stroke:#fff,stroke-width:2px
    style T fill:#b00b1e,stroke:#fff,stroke-width:2px
    style O fill:#3d3d3d,stroke:#fff,stroke-width:2px
```
...
> 
> _Peter Thiel - From Zero to One: Notes on Startups, Or How to Build the Future_
...
![UK GDP per capita, PPP, including and excluding London](/assets/img/graphs/uk-wealth-gap.png)
...
![Firm-level productivity long tail](/assets/img/graphs/firm-productivity-tail.png)
...
![Cost of building high speed rail comparison](/assets/img/graphs/high-speed-rail-costs.png)
