...
subgraph "The Architecture of Capability"

B["<b>The Builder</b><br><i>Creates & Codifies the System</i>"]

M["<b>The Manager</b><br><i>Operates & Stabilises the System</i>"]

I["<b>The Individual Contributor</b><br><i>Creates Value Inside the System</i>"]

end

  

B ==>|Designs & Transmits| M

M ==>|Coordinates & Scales| I

I -.->|Ground Truth Signal| B

  

style B fill:#1a4d2e,stroke:#fff,color:#fff

style M fill:#3d3d3d,stroke:#fff,color:#fff

style I fill:#555555,stroke:#fff,color:#fff
