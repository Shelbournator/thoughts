...
And the question that follows is: what does it actually take to get there? Not as an abstract philosophical question, but as a practical one. What are the conditions? Who has thought most clearly about them? And why, in a culture obsessed with optimisation and self-improvement, does it remain so elusive?
 
## The Invisible Load-Bearing Foundations
 
In the [Civilisational Stack]({% post_url 2026-01-10-the-civilisational-stack %}), I argued that the most important layers of any system are often the least visible. STEM disciplines sit downstream. They are nested within broader conceptual foundations — values, meaning, orientation — that they rely on but rarely interrogate.
...
Not because systems thinking is wrong. But because some systems respond to direct intervention by becoming less of what you're trying to produce. Flourishing is one of them. So is trust. So is creativity. So is sleep, if you've ever tried very hard to fall asleep.
...
And crucially — this cannot be forced.
...
And all of that remains true and useful. But it hits a limit here.
...
The pathway to becoming more fully yourself is not through directed effort at becoming more fully yourself. It is through the suspension of the effort. Through creating a space in which you are accepted — by another person, by a practice, by an environment, by yourself — exactly as you are. And in that acceptance, without any forcing, movement becomes possible that was blocked before.
