...
mermaid: true
toc: true
description: "Why leadership isn't about imposing control, but translating models. Plato's turning of the soul and the systems view of non-domination."
---
...
```mermaid
graph TD
    subgraph "The Conflict State"
        R[Underlying Reality] -->|Filtered by Context| M1[Model A: e.g. Commercial]
