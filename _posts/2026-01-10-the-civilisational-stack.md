...
math: false
mermaid: true
description: "The distinction between practical and liberal education is a category error. It is actually a distinction between the Application Layer and the Kernel."
---
...
```mermaid
graph TD
    S1[Layer 1: Problem Space<br><i>Complex world</i>]
    S2[Layer 2: Conceptual Discovery<br><i>Socrates - Truth</i>]
    S3[Layer 3: Cultural Runtime<br><i>Aristotle - Logic/Math</i>]
    S4[Layer 4: Epistemic Frameworks<br><i>Turing - Computer Science</i>]
    S5[Layer 5: Institutional Scaling<br><i>Google / OpenAI</i>]
    S6[Layer 6: Operational Layer<br><i>Researchers / Engineers</i>]
    S7[Layer 7: User Layer<br><i>Gemini/ChatGPT GUI</i>]

    S1 --> S2 --> S3 --> S4 --> S5 --> S6 --> S7

    style S6 fill:#3d3d3d,stroke:#fff
    style S5 fill:#3d3d3d,stroke:#fff
    style S2 fill:#1a4d2e,stroke:#fff,color:#fff
