...
```mermaid
graph TD
    L1[<b>Level 1: Reasoning</b><br><i>The Tool</i>]
    L2[<b>Level 2: Rationality</b><br><i>The System Health</i>]
    L3[<b>Level 3: Wisdom</b><br><i>The Orientation</i>]

    L3 -->|Directs| L2
    L2 -->|Regulates| L1

    style L2 fill:#1a4d2e,stroke:#fff,color:#fff
    style L3 fill:#3d3d3d,stroke:#fff
```
